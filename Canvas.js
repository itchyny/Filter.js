(function(global) {
  ...
  Filter.Loader.prototype.setLargeImage = function(image) {
    this.imageLarge = image;
  };

  Filter.Loader.prototype.load = function(callback) {
    if (this.loaded) {
      callback(this.data);
      return;
    }
  ...
  Filter.Loader.prototype.loadLarge = function(callback) {
    if (this.loadedLarge) {
  ...
  Filter.Loader.prototype.convertToImage = function(data, callback) {
    var cvs = document.createElement('canvas');
